    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(blank=True, help_text='Formato: 978-3-16-148410-0 o 0-306-40615-2', max_length=17, null=True, verbose_name='ISBN')),
                ('año_publicacion', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1000, message='El año debe ser mayor a 1000'), django.core.validators.MaxValueValidator(2025, message='El año no puede ser futuro')], verbose_name='Año de publicación')),
                ('precio', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=6, validators=[django.core.validators.MinValueValidator(0.01)], verbose_name='Precio')),
                ('descripcion', models.TextField(blank=True, help_text='Sinopsis o resumen del libro', null=True, verbose_name='Descripción')),
        ...
        migrations.AddIndex(
            model_name='libro',
            index=models.Index(fields=['isbn'], name='inicio_libr_isbn_7a51da_idx'),
        ),
